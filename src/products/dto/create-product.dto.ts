// create-product.dto.ts (FULL REVISED CODE)
...
export class CreateProductDto {
  ...
  @ApiProperty({
    ...
    example: '[{"name":{"en":"Watering"},"value":{"en":"Once a week"}}]',
  })
  @jsonTransformer
  ...
  @ApiProperty({
    ...
    example: '[{"currencyId":1,"price":150000}]',
  })
  @jsonTransformer
